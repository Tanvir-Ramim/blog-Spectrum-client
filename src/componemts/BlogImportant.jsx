...
const BlogImportant = () => {
    ...
    return (
        ...
        <div className=" flex justify-center lg:justify-start"   data-aos="flip-down"  >
         <img  className="w-11/12 rounded-lg" src="https://i.ibb.co/Gt2MbP4/technology-communication-icons-symbols-concept.jpg" alt="" />
        </div>

        <div className=" flex flex-col lg:items-start items-center lg:text-left text-center " data-aos="flip-right"  >
